...
//        let fetchRequest: NSFetchRequest<VAModelEntity> = VAModelEntity.fetchRequest() as! NSFetchRequest<VAModelEntity>
//
//        do {
//            // 기존 비디오 자산을 가져옵니다.
...
//            let videoAssetEntity = VAModelEntity(context: context)
//            
//            videoAssetEntity.assetURL = asset.assetURL.absoluteString
...
//        let context = CoreDataStack.shared.context
//        let fetchRequest: NSFetchRequest<ModelEntity> = ModelEntity.fetchRequest() as! NSFetchRequest<ModelEntity>
//
//        do {
//            let videoAssetEntities = try context.fetch(fetchRequest)
...
//    private func convertEntityToVideoAsset(_ entity: ModelEntity) async -> VideoAsset? {
